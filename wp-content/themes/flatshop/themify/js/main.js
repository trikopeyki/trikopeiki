		...
		InitMap: function () {
			...
			if ($('.themify_map').length > 0) {
				if (typeof google !== 'object' || typeof google.maps !== 'object') {
                                    ...
                                    $self.LoadAsync('//web.archive.org/web/20171110110356/https://maps.googleapis.com/maps/api/js?v=3.exp&callback=Themify.MapCallback&key='+themify_vars.map_key, false, true, true);
				}
				else {
                                    $self.MapCallback();
				}
...
/*
     FILE ARCHIVED ON 11:03:56 Nov 10, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:31:24 Feb 18, 2021.
...
playback timings (ms):
  ...
  esindex: 0.016
  load_resource: 156.494
  captures_list: 861.401
  PetaboxLoader3.resolve: 84.802
  exclusion.robots.policy: 0.245
  PetaboxLoader3.datanode: 823.016 (4)
  RedisCDXSource: 4.813
  LoadShardBlock: 827.277 (3)
