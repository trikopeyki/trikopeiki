		...
		fullwidthVimeoCallBack: function ($videos) {
			...
			$.each($videos, function (i, elm) {
				...
				var params = self.videoParams($video),
						mute = params.mute,
						loop = params.loop;
				var $iframe = $('<div class="big-video-wrap themify-video-vmieo"><iframe id="themify-vimeo-' + i + '" src="//web.archive.org/web/20180227140620/https://player.vimeo.com/video/' + elm.id + '?api=1&portrait=0&title=0&title=0&badge=0&player_id=themify-vimeo-' + i + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>');
